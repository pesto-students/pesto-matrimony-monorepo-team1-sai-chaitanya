...
import styles from "./profileOthers.module.scss";
...
const Profile = () => {
  ...
  return (
    <>
      ...
      {/* <EditProfilePage /> */}
      <h1 className={styles.viewOthersProfilePageHeading}>View <span className={styles.userName}>{userProfileInfo?.name}</span> Profile</h1>
      <UserInfoCard
